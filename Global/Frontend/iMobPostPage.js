$(document).ready(() => {
   ...
   $.get("/Api/postsRoutesPath/" + postId , feed => {//essentially what i have done here is keep a data log of all the post sents to an iMobMember's feed
      showcasePostsInCommentThread(feed, $(".postsContainer"));//once post is madde, everything resets back to base settings on frontend
